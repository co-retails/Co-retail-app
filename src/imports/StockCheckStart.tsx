import svgPaths from "./svg-z3abn497ja";
  ...
  return (
    <div className="basis-0 content-stretch flex flex-col grow h-full items-end justify-end min-h-px min-w-px overflow-clip relative shrink-0" data-name="Content">
      <div className="flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#49454f] text-[16px] tracking-[0.5px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[24px]">250 items</p>
      </div>
    </div>
  );
}
    ...
    <div className="box-border content-stretch flex flex-col items-start justify-start pl-[16px] pr-0 py-0 relative shrink-0 w-[133px]" data-name="list item details">
      ...
      <div className="flex flex-col font-['Roboto:Medium',_sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[0px] text-black text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="font-['Roboto:Regular',_sans-serif] font-normal leading-[26px] text-[12px] whitespace-pre">
          ...
          <span style={{ fontVariationSettings: "'wdth' 100" }}>{` 10000002 `}</span>
        </p>
      </div>
  ...
  return (
    <div className="box-border content-stretch flex flex-col items-start justify-start pl-[16px] pr-0 py-0 relative shrink-0 w-[133px]" data-name="list item details">
      ...
      <div className="flex flex-col font-['Roboto:Medium',_sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[0px] text-black text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="font-['Roboto:Regular',_sans-serif] font-normal leading-[26px] text-[12px] whitespace-pre">
          <span style={{ fontVariationSettings: "'wdth' 100" }}>{`2022-06-10  `}</span>
          <span className="text-[#666666]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Order: `}</span>
          <span style={{ fontVariationSettings: "'wdth' 100" }}>{`10000002 `}</span>
        </p>
      </div>
      <div className="flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[12px] text-black text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ItemCardImage4() {
  return (
    <div className="h-[72px] opacity-20 relative shrink-0 w-[55px]" data-name="item card - image">
...
function ListItemDetails4() {
  return (
    <div className="box-border content-stretch flex flex-col items-start justify-start leading-[0] pl-[16px] pr-0 py-0 relative shrink-0 text-black text-nowrap w-[133px]" data-name="list item details">
      <div className="flex flex-col font-['Roboto:Medium',_sans-serif] font-medium justify-center relative shrink-0 text-[0px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="font-['Roboto:Regular',_sans-serif] font-normal leading-[26px] text-[14px] text-nowrap whitespace-pre">
          <span className="text-[#666666]" style={{ fontVariationSettings: "'wdth' 100" }}>
            ID:
          </span>
          <span style={{ fontVariationSettings: "'wdth' 100" }}>{` WKD1234567 `}</span>
        </p>
      </div>
      <div className="flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center relative shrink-0 text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[26px] text-nowrap whitespace-pre">2022-06-05</p>
      </div>
      <div className="flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center relative shrink-0 text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[26px] text-nowrap whitespace-pre">Hope, Jeans, 34/36</p>
      </div>
    </div>
  );
}
...
function ItemCardList4() {
  return (
    <div className="bg-white h-[81px] relative shrink-0 w-[375px]" data-name="Item card - list">
      <div className="absolute h-0 left-0 top-px w-[375px]">
        <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 375 1">
            <line id="Line 3" stroke="var(--stroke-0, #E0E0E0)" x2="375" y1="0.5" y2="0.5" />
...
function Frame73() {
  return (
    <div className="content-stretch flex flex-col h-[455px] items-start justify-start relative shrink-0">
      <Tabs />
...
function ListItems() {
  return (
    <div className="absolute content-stretch flex flex-col h-[589px] items-start justify-start left-0 top-[143px]" data-name="list items">
      <Frame73 />
    </div>
  );
}
...
function IconCheckOff7() {
  return (
    <div className="absolute left-[17px] size-[44px] top-[89px]" data-name="icon_check_off">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 44">
        <g id="icon_check_off">
          <g id="path 32"></g>
          <path clipRule="evenodd" d={svgPaths.p3e435600} fill="var(--fill-0, #FFCCD4)" fillRule="evenodd" id="Shape" />
...
function Select7() {
  return (
    <div className="absolute contents left-[17px] top-[89px]" data-name="Select">
      <IconCheckOff7 />
    </div>
  );
}
...
function SelectAll7() {
  return (
    <div className="absolute contents left-[17px] top-[89px]" data-name="Select All">
      <Select7 />
    </div>
  );
}
...
function IconMorePrimary() {
  return (
    <div className="absolute h-[32px] left-[17.33%] right-[74.13%] top-[95px]" data-name="icon_more_primary">
...
function ButtonVariants() {
  return (
    <button className="absolute bg-error cursor-pointer h-[32px] rounded-[16px] translate-x-[-50%] translate-y-[-50%]" data-name="Button / Variants" style={{ top: "calc(50% - 295px)", left: "calc(50% + 120px)" }}>
      <div className="flex flex-row items-center justify-center relative size-full">
...
function IconClose() {
  return (
    <div className="absolute left-[327px] size-[32px] top-[26px]" data-name="icon_close">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="icon_close">
          <g id="path 32x32" opacity="0.601935"></g>
          <path d={svgPaths.p1196ff0} fill="var(--fill-0, #1A1A1A)" id="icon " opacity="0.8" />
        </g>
      </svg>
    </div>
  );
...
function BtnPrimarySave() {
  return (
    <div className="absolute bottom-0 contents left-0" data-name="btn_primary_save">
      <div className="absolute bg-white bottom-0 h-[83px] left-0 w-[375px]" />
      <div className="absolute bottom-[20px] h-[42px] left-[208px] w-[150px]" data-name="Button BG">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 150 42">
          <path clipRule="evenodd" d={svgPaths.p21fb2980} fill="var(--fill-0, #F20054)" fillRule="evenodd" id="Button BG" opacity="0.5" />
        </svg>
      </div>
      <div className="absolute bottom-[41px] flex flex-col font-['Roboto:Medium',_sans-serif] font-medium h-[42px] justify-center leading-[0] left-[283px] text-[12px] text-center text-white tracking-[1.4px] translate-x-[-50%] translate-y-[50%] w-[150px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[20px]">CONTINUE</p>
      </div>
      <div className="absolute bottom-[82px] h-px left-0 w-[375px]" data-name="divider">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 375 1">
...
export default function StockCheckStart() {
  return (
    <div className="bg-white relative size-full" data-name="Stock check - start">
      <IconClose />
      <BtnPrimarySave />
      <div className="absolute bottom-[741.5px] flex flex-col font-['Roboto:Regular',_sans-serif] font-normal h-[25px] justify-center leading-[0] left-[6.4%] right-[64.8%] text-[#5a5a5a] text-[11px] translate-y-[50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">Scanned: 0/250 items</p>
      </div>
      <ListItems />
      <div className="absolute flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center leading-[0] left-[24px] text-[#1a1a1a] text-[20px] text-nowrap top-[42px] translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[32px] whitespace-pre">Stock check</p>
      </div>
      <SelectAll7 />
      <IconMorePrimary />
      <ButtonVariants />
      <div className="absolute flex flex-col font-['Roboto:Medium',_sans-serif] font-medium h-[20px] justify-center leading-[0] left-[194px] text-[#f20054] text-[12px] text-center top-[111px] tracking-[1px] translate-x-[-50%] translate-y-[-50%] uppercase w-[108px]" style={{ fontVariationSettings: "'wdth' 100" }}>
