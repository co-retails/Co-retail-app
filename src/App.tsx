...
export default function App() {
  ...
  const handleNavigateToShipmentsTab = () => {
    setCurrentScreenSafe('shipping');
    // Use 'in-transit' for partner portal (including admin emulating partner), 'shipments' for store app
    ...
    >
      ...
      {currentScreen === 'shipping' && (
        <ShippingScreen
          ...
          // Effective portal role for ShippingScreen tabs/layout; isAdmin still reflects real account
          ...
          onCreateOrder={appViewRole === 'partner' ? () => handleCreateOrder('shipping') : undefined}
